    ...
    return (
        <section className="relative mx-auto max-w-6xl px-6 py-12 sm:px-8 lg:px-12">
            <div className="grid gap-6 lg:grid-cols-2">
                <div id="home" className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-slate-950/40 backdrop-blur-xl transition hover:-translate-y-1 hover:border-cyan-300/30 hover:bg-slate-900/70 animate-fade-in-left scroll-mt-32">
                ...
                <div id="about" className="rounded-[2rem] border border-white/10 bg-white/5 p-8 shadow-2xl shadow-slate-950/40 backdrop-blur-xl transition hover:-translate-y-1 hover:border-cyan-300/30 hover:bg-slate-900/70 animate-fade-in-right scroll-mt-32">
                    <div className="space-y-4">
