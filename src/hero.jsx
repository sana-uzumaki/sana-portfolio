...
export default function Hero() {
    ...
    return (
        <section id="hero" className="scroll-mt-10 relative mx-auto max-w-6xl px-6 py-10 sm:px-8 lg:px-12 items-centeralign">
            <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6 shadow-2xl shadow-slate-950/40 backdrop-blur-xl sm:p-8 flex flex-col justify-center">
