...
export default function Projects() {
    const projects = [
	    ...
	    return (
	        <section id="projects" className="relative mx-auto max-w-6xl px-6 py-12 sm:px-8 lg:px-12">
            ...
            <div className="grid gap-6 lg:grid-cols-3">
                {projects.map((project) => (
                    <article key={project.title} className="rounded-[2rem] border border-white/10 bg-white/5 p-6 shadow-xl shadow-slate-950/40 backdrop-blur-xl transition hover:-translate-y-1 hover:border-cyan-300/30 hover:bg-slate-900/70">
