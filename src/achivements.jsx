...
export default function Achievements() {
    return (
        <>
            ...
            <div className='bg-blue-400/20 border border-blue-400  p-6 rounded-2xl shadow-sm shadow-blue-400 hover:shadow-lg/50 cursor-pointer transform hover:scale-105 transition duration-300'>
